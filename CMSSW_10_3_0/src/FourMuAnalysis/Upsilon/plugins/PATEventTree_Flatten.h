...
class PATEventTree : public edm::EDAnalyzer {
 ...
 private:
  ...
  float  fHLT_MuonJpsi_L3Matching_Pt[10];
  float  fHLT_MuonJpsi_L3Matching_Eta[10];
  float  fHLT_MuonJpsi_L3Matching_Phi[10];
  float  fHLT_MuonJpsi_VtxMatching_Pt[10];
  float  fHLT_MuonJpsi_VtxMatching_Eta[10];
  float  fHLT_MuonJpsi_VtxMatching_Phi[10];
  float  fHLT_MuonUpsilon_L3Matching_Pt[10];
  float  fHLT_MuonUpsilon_L3Matching_Eta[10];
  float  fHLT_MuonUpsilon_L3Matching_Phi[10];
  float  fHLT_MuonUpsilon_VtxMatching_Pt[10];
  float  fHLT_MuonUpsilon_VtxMatching_Eta[10];
  float  fHLT_MuonUpsilon_VtxMatching_Phi[10];
  float  fHLT_MuonZ_L3Matching_Pt[10];
  float  fHLT_MuonZ_L3Matching_Eta[10];
  float  fHLT_MuonZ_L3Matching_Phi[10];
  float  fHLT_MuonZ_VtxMatching_Pt[10];
  float  fHLT_MuonZ_VtxMatching_Eta[10];
  float  fHLT_MuonZ_VtxMatching_Phi[10];
  //end                                           
  int trigPath;
  int trigPathUps;
  int trigPathZ;
  ...
  bool  fHLT_Mu[HLTMAX][2], fHLT_Mu12[HLTMAX][2], fHLT_Mu15[HLTMAX][2], fHLT_Mu20[HLTMAX][2], fHLT_Mu24[HLTMAX][2], fHLT_Mu30[HLTMAX][2], fHLT_IsoMu12[HLTMAX][2], fHLT_IsoMu15[HLTMAX][2], fHLT_IsoMu17[HLTMAX][2], fHLT_IsoMu30[HLTMAX][2], fHLT_DoubleMu3[HLTMAX][2], fHLT_DoubleMu6[HLTMAX][2], fHLT_DoubleMu7[HLTMAX][2],fHLT_Dimuon0_Upsilon_Muon[HLTMAX][2], fHLT_Dimuon0_Jpsi3p5_Muon2[HLTMAX][2], fHLT_Dimuon0_Jpsi[HLTMAX][2], fHLT_Dimuon7_Jpsi_Displaced[HLTMAX][2], fHLT_Dimuon7_Jpsi_X_Barrel[HLTMAX][2], fHLT_Dimuon10_Jpsi_Barrel[HLTMAX][2], fHLT_TripleMu5[HLTMAX][2], fHLT_QuadMuon0_Dimuon0_Jpsi[HLTMAX][2], fHLT_QuadMuon0_Dimuon0_Upsilon[HLTMAX][2], fHLT_Jet[HLTMAX][2], fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[HLTMAX][8], fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[HLTMAX][11], fHLT_Trimuon5_3p5_2_Upsilon_Muon[HLTMAX][2];
  int fHLT_Dimuon0_Jpsi3p5_Muon2p5_Muon2_Path;
  bool fHLT_IsoMu27[HLTMAX][2],fHLT_IsoMu24[HLTMAX][2];

  // -- Particles
  static const int PARTMAX = 10000;
  int   fPcN, fTkN, fMuN, fElecN, fMiscTkN, fPhotN; //fHp5_Muon2adrN, 
