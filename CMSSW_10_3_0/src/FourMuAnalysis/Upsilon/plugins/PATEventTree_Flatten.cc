...
PATEventTree::PATEventTree(edm::ParameterSet const& iConfig): 
  ...
  //fHLTPathLabel(iConfig.getUntrackedParameter<InputTag>("HLTPathLabel", edm::InputTag("TriggerResults::HLT"))),//original
  fHLTPathLabel(iConfig.getUntrackedParameter<InputTag>("HLTPathLabel", edm::InputTag("TriggerResults::HLT"))),
  fHLTFilterLabel(iConfig.getUntrackedParameter<InputTag>("HLTFilterLabel", edm::InputTag("hltTriggerSummaryAOD"))),//defyning filter//ORIGINAL
  //fHLTFilterLabel(iConfig.getUntrackedParameter<InputTag>("HLTFilterLabel", edm::InputTag("hltCollectionFilters"))),//defyning filter
  ...
  fInit(0),
  fHltPrescale(iConfig, consumesCollector(), *this) //defining prescale
...
void PATEventTree::beginJob() {
  ...
  fTree->Branch("HLTP_IsoMu24", fHLTP_IsoMu24, "HLTP_IsoMu24[3]/O");
  //addition for Upsilon trigger
  fTree->Branch("HLTP_Trimuon5_3p5_2_Upsilon_Muon", fHLTP_Trimuon5_3p5_2_Upsilon_Muon, "HLTP_Trimuon5_3p5_2_Upsilon_Muon[3]/O");
  fTree->Branch("HLTP_Trimuon2_Upsilon5_Muon", fHLTP_Trimuon2_Upsilon5_Muon, "HLTP_Trimuon2_Upsilon5_Muon[3]/O");
  fTree->Branch("HLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon", fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon, "HLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon[3]/O");
  //end

  //addition of Upsilon trigger Prescale
  fTree->Branch("HLTP_Trimuon5_3p5_2_Upsilon_Muon_PS", &fHLTP_Trimuon5_3p5_2_Upsilon_Muon_PS, "HLTP_Trimuon5_3p5_2_Upsilon_Muon/i");
  fTree->Branch("HLTP_Trimuon2_Upsilon5_Muon_PS", &fHLTP_Trimuon2_Upsilon5_Muon_PS, "HLTP_Trimuon2_Upsilon5_Muon_PS/i");
  fTree->Branch("HLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon_PS", &fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon_PS, "HLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon_PS/i");
  //end of prescale
  //addition of Upsilon trigger Filter
  ...
  fTree->Branch("HLT_Dimuon0_Jpsi3p5_Muon2", fHLT_Dimuon0_Jpsi3p5_Muon2, "HLT_Dimuon0_Jpsi3p5_Muon2[HLTN][2]/O");
  fTree->Branch("HLT_IsoMu27", fHLT_IsoMu27, "HLT_IsoMu27[HLTN][2]/O");
  fTree->Branch("HLT_IsoMu24", fHLT_IsoMu24, "HLT_IsoMu24[HLTN][2]/O");
  
  //fTree->Branch("HLT_Dimuon0_Jpsi3p5_Muon2_Path", fHLT_Dimuon0_Jpsi3p5_Muon2_Path, "HLT_Dimuon0_Jpsi3p5_Muon2_Path/i");
  fTree->Branch("HLT_Dimuon0_Jpsi3p5_Muon2_Filters",  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters, "HLT_Dimuon0_Jpsi3p5_Muon2_Filters[HLTN][8]/O");
  fTree->Branch("HLT_Trimuon5_3p5_2_Upsilon_Muon_Filters",  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters, "HLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[HLTN][11]/O");
  fTree->Branch("HLT_Trimuon5_3p5_2_Upsilon_Muon", fHLT_Trimuon5_3p5_2_Upsilon_Muon, "HLT_Trimuon5_3p5_2_Upsilon_Muon[HLTN][2]/O");
...
//  fTree->Branch("MuChambers",	&fMuChambers,	"MuChambers[MuN]/I");
  ...
  fTree->Branch("HLT_Muon_VertexmumuJpsi",       fHLT_Muon_VertexmumuJpsi,          "HLT_Muon_VertexmumuJpsi[HLTN]/F");
  fTree->Branch("HLT_Muon_TripleMuL3",         fHLT_Muon_TripleMuL3,          "HLT_Muon_TripleMuL3[HLTN]/F");         
  //addition for trigger matching                                                                                                                                                  
  //For JPsi matching                                                                                                                                                              
  fTree->Branch("HLT_MuonJpsi_L3Matching_Pt",  fHLT_MuonJpsi_L3Matching_Pt,          "HLT_MuonJpsi_L3Matching_Pt[10]/F");
  fTree->Branch("HLT_MuonJpsi_L3Matching_Eta", fHLT_MuonJpsi_L3Matching_Eta,          "HLT_MuonJpsi_L3Matching_Eta[10]/F");
  fTree->Branch("HLT_MuonJpsi_L3Matching_Phi", fHLT_MuonJpsi_L3Matching_Phi,          "HLT_MuonJpsi_L3Matching_Phi[10]/F");
  fTree->Branch("HLT_MuonJpsi_VtxMatching_Pt",  fHLT_MuonJpsi_VtxMatching_Pt,          "HLT_MuonJpsi_VtxMatching_Pt[10]/F");
  fTree->Branch("HLT_MuonJpsi_VtxMatching_Eta", fHLT_MuonJpsi_VtxMatching_Eta,          "HLT_MuonJpsi_VtxMatching_Eta[10]/F");
  fTree->Branch("HLT_MuonJpsi_VtxMatching_Phi", fHLT_MuonJpsi_VtxMatching_Phi,          "HLT_MuonJpsi_VtxMatching_Phi[10]/F");
  //For Upsilon matching                                                                                                                                                           
  fTree->Branch("HLT_MuonUpsilon_L3Matching_Pt",  fHLT_MuonUpsilon_L3Matching_Pt,          "HLT_MuonUpsilon_L3Matching_Pt[10]/F");
  fTree->Branch("HLT_MuonUpsilon_L3Matching_Eta", fHLT_MuonUpsilon_L3Matching_Eta,          "HLT_MuonUpsilon_L3Matching_Eta[10]/F");
  fTree->Branch("HLT_MuonUpsilon_L3Matching_Phi", fHLT_MuonUpsilon_L3Matching_Phi,          "HLT_MuonUpsilon_L3Matching_Phi[10]/F");
  fTree->Branch("HLT_MuonUpsilon_VtxMatching_Pt",  fHLT_MuonUpsilon_VtxMatching_Pt,          "HLT_MuonUpsilon_VtxMatching_Pt[10]/F");
  fTree->Branch("HLT_MuonUpsilon_VtxMatching_Eta", fHLT_MuonUpsilon_VtxMatching_Eta,          "HLT_MuonUpsilon_VtxMatching_Eta[10]/F");
  fTree->Branch("HLT_MuonUpsilon_VtxMatching_Phi", fHLT_MuonUpsilon_VtxMatching_Phi,          "HLT_MuonUpsilon_VtxMatching_Phi[10]/F");
  //For Z matching                                                                                                                                                                 
  fTree->Branch("HLT_MuonZ_L3Matching_Pt",  fHLT_MuonZ_L3Matching_Pt,          "HLT_Muon_L3MatchingZ_Pt[10]/F");
  fTree->Branch("HLT_MuonZ_L3Matching_Eta", fHLT_MuonZ_L3Matching_Eta,          "HLT_Muon_L3MatchingZ_Eta[10]/F");
  fTree->Branch("HLT_MuonZ_L3Matching_Phi", fHLT_MuonZ_L3Matching_Phi,          "HLT_Muon_L3MatchingZ_Phi[10]/F");
  fTree->Branch("HLT_MuonZ_VtxMatching_Pt",  fHLT_MuonZ_VtxMatching_Pt,          "HLT_Muon_VtxMatchingZ_Pt[10]/F");
  fTree->Branch("HLT_MuonZ_VtxMatching_Eta", fHLT_MuonZ_VtxMatching_Eta,          "HLT_Muon_VtxMatchingZ_Eta[10]/F");
  fTree->Branch("HLT_MuonZ_VtxMatching_Phi", fHLT_MuonZ_VtxMatching_Phi,          "HLT_Muon_VtxMatchingZ_Phi[10]/F");
  //end                                                                                                                        
...
//  cout << "Event info" << endl;
 ...
 // std::cout<<" Run="<<iEvent.id().run()<<"Event="<<iEvent.id().event()<<std::endl;
  ...
  //cout<<"we go the setted prescale as -->"<<psSet<<endl;
  Handle<TriggerResults> hHLTresults;
  bool hltF = true;
  try {
    iEvent.getByLabel(fHLTPathLabel, hHLTresults);
  } catch (cms::Exception &ex) {
    //cout<<"GotException on trigger Label"<<endl;
    hltF = false;
  }
  ...
  try {
    ...
    hltF = false;
    //cout<<"Got Exception on by filter Label"<<endl;
  }
  ...
  //if ( fHLT_Skim && !( fHLTP_Dimuon0_Jpsi_Muon[1])) return; // only ntuplize events passing trigger if skimming enabled
  //if ( fHLT_Skim && !( fHLTP_Dimuon0_Jpsi3p5_Muon2[1])) return;
 ...
 // if ( fHLT_Skim && !(fHLTP_Dimuon0_Upsilon_Muon[1] || fHLTP_Dimuon0_Jpsi_Muon[1] || fHLTP_QuadMuon0_Dimuon0_Jpsi[1] || fHLTP_QuadMuon0_Dimuon0_Upsilon[1]) ) return; // only ntuplize events passing trigger if skimming enabled
  ...
  if ( HLTHandle.isValid() ){
    fillHLT( *(HLTHandle.product()) );
    if (trigPath>2){
      fHLTP_Dimuon0_Jpsi3p5_Muon2[1]=true;
      //cout <<"final triggered object in a Event-->"<<trigPath <<" for Jpsi"<<endl; 
    }
    if (trigPathUps>2){
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon[1]=true;
      //cout <<"final triggered object in a Event-->"<<trigPathUps<<" for Upsilon"<<endl; 
    }
    if (trigPathZ>1){
      fHLTP_IsoMu27[1]=true;
      cout <<"final triggered object in a Event-->"<<trigPathZ<<" for Z"<<endl; 
    }
    if (trigPathZ1>1){
      fHLTP_IsoMu24[1]=true;
      cout <<"final triggered object in a Event-->"<<trigPathZ1<<" for Z"<<endl; 
    }
  }
    
  else { cout << "--> No valid HLT collection" << endl; }
  if ( fHLT_Skim && !( fHLTP_Trimuon5_3p5_2_Upsilon_Muon[1] || fHLTP_Dimuon0_Jpsi3p5_Muon2[1] ||  fHLTP_IsoMu27[1] || fHLTP_IsoMu24[1])) return; 
  ...
  if ( METHandle.isValid() ) fillMET( *(METHandle.product()) );
    ...
    //cout << "--> No valid MET collection" << endl; 
  }
  ...
  //  cout << "<sms> final # J/psi : " << fJPsiN << endl;

  if ( fJPsiN>1 ) makeEtabCand( t_tks );

  //if ( JPsiHimalMass>=2 ) makeEtabCand( t_tks ); 
  // ----------------------------------------------------------------------
  // -- Higgs Candidates
  // ----------------------------------------------------------------------
...
void PATEventTree::init() {
  ...
  fHLTP_DoubleMu3_PS = fHLTP_DoubleMu6_PS = fHLTP_DoubleMu7_PS = fHLTP_Dimuon0_Upsilon_Muon_PS = fHLTP_Dimuon0_Jpsi3p5_Muon2_PS = fHLTP_Dimuon0_Jpsi_PS = fHLTP_Dimuon10_Jpsi_Barrel_PS = fHLTP_TripleMu5_PS = fHLTP_QuadMuon0_Dimuon0_Jpsi_PS = fHLTP_QuadMuon0_Dimuon0_Upsilon_PS = fHLTP_Trimuon5_3p5_2_Upsilon_Muon_PS = fHLTP_Trimuon2_Upsilon5_Muon_PS = fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon_PS = 0;
  
  for (int i = 0; i < 3; i++) {
    fHLTP_DoubleMu3[i] = fHLTP_DoubleMu6[i] = fHLTP_DoubleMu7[i] = fHLTP_Dimuon0_Upsilon_Muon[i] = fHLTP_Dimuon0_Jpsi3p5_Muon2[i] = fHLTP_Dimuon0_Jpsi[i] = fHLTP_Dimuon10_Jpsi_Barrel[i] = fHLTP_TripleMu5[i] = fHLTP_QuadMuon0_Dimuon0_Jpsi[i] = fHLTP_QuadMuon0_Dimuon0_Upsilon[i] = fHLTP_Trimuon5_3p5_2_Upsilon_Muon[i] = fHLTP_Trimuon2_Upsilon5_Muon[i] = fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon[i] = fHLTP_IsoMu27[i]=  fHLTP_IsoMu24[i] = false;
  }
  for (int i=0; i<11; i++){
    fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[i]=false;
  }
  for (int i = 0; i < 5; i++) {
    fHLTP_DoubleMu3_Filters[i] = fHLTP_DoubleMu6_Filters[i] = fHLTP_DoubleMu7_Filters[i] = fHLTP_TripleMu5_Filters[i] = fHLTP_Dimuon0_Jpsi_Filters[i] = fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[i] = fHLTP_Dimuon10_Jpsi_Barrel_Filters[i] = false;
  }
  fHLTP_Dimuon0_Jpsi_Filters[5] = fHLTP_Dimuon0_Jpsi_Filters[6] = fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[5] = fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[6] = fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[7] = fHLTP_Dimuon10_Jpsi_Barrel_Filters[5] = fHLTP_Dimuon10_Jpsi_Barrel_Filters[6] = false;

//himal addition for trigger matching
  for (int i = 0; i < fHLTN; i++) {
       fHLT_Muon_Eta[i] = fHLT_Muon_Phi[i]= fHLT_Muon_Pt[i]= -9999;
       fHLT_Muon_VertexmumuJpsi[i] = fHLT_Muon_TripleMuL3[i] = -9999;
  }
  //himal addition for trigger matching
  for (int i = 0; i < fHLTN; i++) {
    fHLT_Muon_Eta[i] = fHLT_Muon_Phi[i]= fHLT_Muon_Pt[i]= -9999;
  ...
  for (int i = 0; i < 10; i++) {
    fHLT_MuonJpsi_L3Matching_Pt[i]=-9999;
    fHLT_MuonJpsi_L3Matching_Eta[i]=-9999;
    fHLT_MuonJpsi_L3Matching_Phi[i]=-9999;
    fHLT_MuonJpsi_VtxMatching_Pt[i]=-9999;
    fHLT_MuonJpsi_VtxMatching_Eta[i]=-9999;
    fHLT_MuonJpsi_VtxMatching_Phi[i]=-9999;
    fHLT_MuonUpsilon_L3Matching_Pt[i]=-9999;
    fHLT_MuonUpsilon_L3Matching_Eta[i]=-9999;
    fHLT_MuonUpsilon_L3Matching_Phi[i]=-9999;
    fHLT_MuonUpsilon_VtxMatching_Pt[i]=-9999;
    fHLT_MuonUpsilon_VtxMatching_Eta[i]=-9999;
    fHLT_MuonUpsilon_VtxMatching_Phi[i]=-9999;
    fHLT_MuonZ_L3Matching_Pt[i]=-9999;
    fHLT_MuonZ_L3Matching_Eta[i]=-9999;
    fHLT_MuonZ_L3Matching_Phi[i]=-9999;
    fHLT_MuonZ_VtxMatching_Pt[i]=-9999;
    fHLT_MuonZ_VtxMatching_Eta[i]=-9999;
    fHLT_MuonZ_VtxMatching_Phi[i]=-9999;
  }
  //end                                                                                                                                                      


  //addition of the initialiazation of trigger path count
...
//cout<<"Let me summarize this--->Prescale "<<psSet<<"hHLTresults is ---> "<< edm::TriggerResults& <<"triggerEvent is ---->"<<trigger::TriggerEvent& <<endl;
void PATEventTree::fillHLTPath(const unsigned int psSet,  const edm::Handle<edm::TriggerResults>& hHLTresults, const trigger::TriggerEvent& triggerEvent){
  cout<<"Himal working to add trigger"<<endl;
  ...
  for (unsigned int itrig = 0; itrig < validTriggerNames.size(); itrig++) {
    ...
    } else if (validTriggerNames[itrig].find("HLT_Dimuon0_Jpsi3p5_Muon2_v5")!=string::npos) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2[0] = wasrun;
      fHLTP_Dimuon0_Jpsi3p5_Muon2[1] = accept;
      fHLTP_Dimuon0_Jpsi3p5_Muon2[2] = error;
      fHLTP_Dimuon0_Jpsi3p5_Muon2_PS = prescale;
    } else if (validTriggerNames[itrig].find("HLT_Dimuon0_Jpsi3p5_Muon2_v6")!=string::npos) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2[0] = wasrun;
      fHLTP_Dimuon0_Jpsi3p5_Muon2[1] = accept;
      fHLTP_Dimuon0_Jpsi3p5_Muon2[2] = error;
      fHLTP_Dimuon0_Jpsi3p5_Muon2_PS = prescale;
      //addition of trigge for Upsilon
    } else if (validTriggerNames[itrig].find("HLT_Trimuon5_3p5_2_Upsilon_Muon")!=string::npos) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon[0] = wasrun;
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon[1] = accept;
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon[2] = error;
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_PS = prescale;
    } else if (validTriggerNames[itrig].find("HLT_Trimuon2_Upsilon5_Muon")!=string::npos) {
      fHLTP_Trimuon2_Upsilon5_Muon[0] = wasrun;
      fHLTP_Trimuon2_Upsilon5_Muon[1] = accept;
      fHLTP_Trimuon2_Upsilon5_Muon[2] = error;
      fHLTP_Trimuon2_Upsilon5_Muon_PS = prescale;
    } else if (validTriggerNames[itrig].find("HLT_TrimuonOpen_5_3p5_2_Upsilon_Muon")!=string::npos) {
      fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon[0] = wasrun;
      fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon[1] = accept;
      fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon[2] = error;
      fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon_PS = prescale;
      //end
  ...
  for(uint filterIndex=0;filterIndex<triggerEvent.sizeFilters();++filterIndex){  //loop over all trigger filters in event (i.e. filters passed)
    ...
    if(label.find( "hltL1sL1DoubleMu0" ) != string::npos ) {
      ...
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[0] = true;
      fHLTP_Dimuon10_Jpsi_Barrel_Filters[0] = true;
    } else if(label.find( "hltPreDimuon0Jpsi3p5Muon2" ) != string::npos ) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[1] = true;
    } else if(label.find( "hltTripleMuonL1Filtered0" ) != string::npos ) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[2] = true;
      //    } else if(label.find( "hltTripleMuonL2PreFiltered0" ) != string::npos ) {
      //  fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[3] = true;
    } else if(label.find( "hltTripleMuL3PreFiltered222" ) != string::npos ) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[4] = true;
    } else if(label.find( "hltJpsiMuonL3Filtered3p5" ) != string::npos ) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[5] = true;
    } else if(label.find( "hltDisplacedmumuVtxProducerJpsiMuon3p5" ) != string::npos ) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[6] = true;
    } else if(label.find( "hltVertexmumuFilterJpsiMuon3p5" ) != string::npos ) {
      fHLTP_Dimuon0_Jpsi3p5_Muon2_Filters[7] = true;

      //addition of filter for the Upsilon trigger
    } else if(label.find( "hltL1sTripleMuV1OSM5to17" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[0]=true;
    } else if(label.find( "hltPreTrimuon53p52UpsilonMuon" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[1]=true;
    } else if(label.find( "hltTripleMuonV2L1Filtered0" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[2]=true;
    } else if(label.find( "HLTL2muonrecoSequence" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[3]=true;
    } else if(label.find( "HLTL3muonrecoSequence" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[4]=true;
    } else if(label.find( "hltTripleMuL3V2PreFiltered0" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[5]=true;
    } else if(label.find( "hltTripleMuL3V2bPreFiltered0" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[6]=true;
    } else if(label.find( "hltTripleMuL3V2cPreFiltered0" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[7]=true;
    } else if(label.find( "hltUpsilonMuonL3Filtered" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[8]=true;
    } else if(label.find( "hltDisplacedmumuVtxProducerUpsilonMuon" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[9]=true;
    } else if(label.find( "hltVertexmumuFilterUpsilonMuon" ) != string::npos ) {
      fHLTP_Trimuon5_3p5_2_Upsilon_Muon_Filters[10]=true;
      //end of Upsilon filter
...
void PATEventTree::fillHLT(const pat::TriggerObjectStandAloneCollection& HLTObjects) {
  ...
  int pass1,pass2,passUps1,passUps2,passZ,passZ1;
 pass1=pass2=passUps1=passUps2=passZ=passZ1=0;
  ...
  for ( int ih = 0; ih < (int) HLTObjects.size(); ih++) {
    ...
    //TriggerMatching
    //--------------------
    //std::string filter1 = "hltJpsiMuonL3Filtered"; //filter1 and filter2 or filter 3    
    std::string filter3 = "hltJpsiMuonL3Filtered3p5";// The last trigger selected..
    std::string filter2 = "hltTripleMuL3PreFiltered222"; //General Trigger path which first trigger our Trigger
    
    std::string filterZ = "hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p09"; //L3 Trigger Path for Z IsoMu27 trigger
    std::string filterZ1 = "hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p07"; //L3 Trigger Path for Z IsoMu24 trigger
    std::string filter2Ups = "hltUpsilonMuonL3Filtered";
    std::string filter3Ups = "hltVertexmumuFilterUpsilonMuon";
    
    //Himal addition for trigger JPsi
    for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
      if (HLTObjects[fHLTN].filterLabels()[h] == filter2 ) {
        fHLT_Muon_Pt[fHLTN] = HLTObjects[fHLTN].pt();
        fHLT_Muon_Phi[fHLTN] = HLTObjects[fHLTN].eta();
        fHLT_Muon_Eta[fHLTN] = HLTObjects[fHLTN].phi();
        fHLT_Muon_VertexmumuJpsi[fHLTN] = 0;
        fHLT_Muon_TripleMuL3[fHLTN] = 1;
        fHLT_MuonJpsi_L3Matching_Pt[pass1]  = HLTObjects[fHLTN].pt();
        fHLT_MuonJpsi_L3Matching_Eta[pass1] = HLTObjects[fHLTN].eta();
        fHLT_MuonJpsi_L3Matching_Phi[pass1] = HLTObjects[fHLTN].phi();
        ++pass1;

      }
      for (unsigned p = 0; p<HLTObjects[fHLTN].filterLabels().size();++p) {
        if (HLTObjects[fHLTN].filterLabels()[h] == filter2) {
          if (HLTObjects[fHLTN].filterLabels()[p]==filter3){
            fHLT_Muon_Pt[fHLTN] = HLTObjects[fHLTN].pt();
            fHLT_Muon_Phi[fHLTN] = HLTObjects[fHLTN].eta();
            fHLT_Muon_Eta[fHLTN] = HLTObjects[fHLTN].phi();
            fHLT_Muon_VertexmumuJpsi[fHLTN] = 1;
            fHLT_Muon_TripleMuL3[fHLTN] = 1;
            fHLT_MuonJpsi_VtxMatching_Pt[pass2]  = HLTObjects[fHLTN].pt();
            fHLT_MuonJpsi_VtxMatching_Eta[pass2]  = HLTObjects[fHLTN].eta();
            fHLT_MuonJpsi_VtxMatching_Phi[pass2]  = HLTObjects[fHLTN].phi();
            ++pass2;
          }
        }
      }
    ...
    //end
    //Himal addition for trigger matching Upsilon
    for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
      if (HLTObjects[fHLTN].filterLabels()[h] == filter2Ups ) {
        fHLT_MuonUpsilon_L3Matching_Pt[passUps1]  = HLTObjects[fHLTN].pt();
        fHLT_MuonUpsilon_L3Matching_Eta[passUps1] = HLTObjects[fHLTN].eta();
        fHLT_MuonUpsilon_L3Matching_Phi[passUps1] = HLTObjects[fHLTN].phi();
        ++passUps1;
	//cout<<"have UpsilonFilter"<<endl;

      }
      for (unsigned p = 0; p<HLTObjects[fHLTN].filterLabels().size();++p) {
        if (HLTObjects[fHLTN].filterLabels()[h] == filter2Ups) {
          if (HLTObjects[fHLTN].filterLabels()[p]==filter3Ups){
            fHLT_MuonUpsilon_VtxMatching_Pt[passUps2]  = HLTObjects[fHLTN].pt();
            fHLT_MuonUpsilon_VtxMatching_Eta[passUps2]  = HLTObjects[fHLTN].eta();
            fHLT_MuonUpsilon_VtxMatching_Phi[passUps2]  = HLTObjects[fHLTN].phi();
            ++passUps2;
	    //cout<<"have UpsilonFilter Vertex"<<endl;
          }
        }
      }
    }
    //Himal addition of trigger matching Z 
    for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
      if (HLTObjects[fHLTN].filterLabels()[h] == filterZ ) {
        fHLT_MuonZ_L3Matching_Pt[passZ]  = HLTObjects[fHLTN].pt();
        fHLT_MuonZ_L3Matching_Eta[passZ] = HLTObjects[fHLTN].eta();
        fHLT_MuonZ_L3Matching_Phi[passZ] = HLTObjects[fHLTN].phi();
        ++passZ;
	//cout<<"have Z Filter"<<endl;
      }
      if (HLTObjects[fHLTN].filterLabels()[h] == filterZ1 ) {
        fHLT_MuonZ_VtxMatching_Pt[passZ1]  = HLTObjects[fHLTN].pt();
        fHLT_MuonZ_VtxMatching_Eta[passZ1] = HLTObjects[fHLTN].eta();
        fHLT_MuonZ_VtxMatching_Phi[passZ1] = HLTObjects[fHLTN].phi();
        ++passZ1;
	//cout<<"have Z Filter"<<endl;
      }
    ...
    //NOW DEFINE TRIGGER HERE HIMAL
    //JPSI TRIGGER
    if( HLTObjects[fHLTN].hasPathName("HLT_Dimuon0_Jpsi3p5_Muon2_v5", false, false) ){
      fHLT_Dimuon0_Jpsi3p5_Muon2[fHLTN][0] = true;
      //cout<<"Found JpsiTrigger Path by Himal"<<endl;
      trigPath++;
      
    }
    if( HLTObjects[fHLTN].hasPathName("HLT_Dimuon0_Jpsi3p5_Muon2_v6", false, false) ){
      fHLT_Dimuon0_Jpsi3p5_Muon2[fHLTN][0] = true;
      //cout<<"Found JpsiTrigger Path by Himal"<<endl;
      trigPath++;
    }
    
    if( HLTObjects[fHLTN].hasPathName("HLT_Trimuon5_3p5_2_Upsilon_Muon_v5", false, false) ){
      fHLT_Trimuon5_3p5_2_Upsilon_Muon[fHLTN][0] = true;
      //cout<<"Found UpsTrigger Path by Himal"<<endl;
      trigPathUps++;
    }
    if( HLTObjects[fHLTN].hasPathName("HLT_Trimuon5_3p5_2_Upsilon_Muon_v4", false, false) ){
      fHLT_Trimuon5_3p5_2_Upsilon_Muon[fHLTN][0] = true;
      //cout<<"Found UpsTrigger Path by Himal"<<endl;
      trigPathUps++;
    }

    if( HLTObjects[fHLTN].hasPathName("HLT_IsoMu27_v14", false, false) ){
      fHLT_IsoMu27[fHLTN][0] = true;
      cout<<"Found ZTrigger Path by Himal"<<endl;
      trigPathZ++;
    }
    if( HLTObjects[fHLTN].hasPathName("HLT_IsoMu27_v15", false, false) ){
      fHLT_IsoMu27[fHLTN][0] = true;
      cout<<"Found ZTrigger Path by Himal"<<endl;
      trigPathZ++;
    }    
    if( HLTObjects[fHLTN].hasPathName("HLT_IsoMu27_v16", false, false) ){
      fHLT_IsoMu27[fHLTN][0] = true;
      cout<<"Found ZTrigger Path by Himal"<<endl;
      trigPathZ++;
    }
    if( HLTObjects[fHLTN].hasPathName("HLT_IsoMu24_v11", false, false) ){
      fHLT_IsoMu24[fHLTN][0] = true;
      cout<<"Found ZTrigger Path by Himal"<<endl;
      trigPathZ1++;
    }
    if( HLTObjects[fHLTN].hasPathName("HLT_IsoMu24_v12", false, false) ){
      fHLT_IsoMu24[fHLTN][0] = true;
      cout<<"Found ZTrigger Path by Himal"<<endl;
      trigPathZ1++;
    }
    if( HLTObjects[fHLTN].hasPathName("HLT_IsoMu24_v13", false, false) ){
      fHLT_IsoMu24[fHLTN][0] = true;
      cout<<"Found ZTrigger Path by Himal"<<endl;
      trigPathZ1++;
    }
    ...
    //to add trigger Filter
    if( HLTObjects[fHLTN].hasPathName("HLT_Trimuon5_3p5_2_Upsilon_Muon_v5", true, false) ) {
      fHLT_Trimuon5_3p5_2_Upsilon_Muon[fHLTN][1] = true;
      //Upsilon FIlters
      for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltL1sTripleMuV1OSM5to17") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][0]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltPreTrimuon53p52UpsilonMuon") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][1]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuonV2L1Filtered0") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][2]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuonV2L2PreFiltered0") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][3]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltL1fForIterL3TripleMuonV2L1Filtered0") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][4]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuL3V2PreFiltered0") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][5]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuL3V2bPreFiltered0") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][6]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuL3V2cPreFiltered0") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][7]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltUpsilonMuonL3Filtered") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][8]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltDisplacedmumuVtxProducerUpsilonMuon") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][9]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "fHLT_Trimuon5_3p5_2_Upsilon_Muon") {
	  fHLT_Trimuon5_3p5_2_Upsilon_Muon_Filters[fHLTN][10]=true;
	}
      }
    }
    
    if( HLTObjects[fHLTN].hasPathName("HLT_Trimuon5_3p5_2_Upsilon_Muon_v4", true, false) ) {
      fHLT_Trimuon5_3p5_2_Upsilon_Muon[fHLTN][1] = true;
      //Upsilon FIlters
      for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltL1sTripleMuV1OSM5to17") {
    ...
    if( HLTObjects[fHLTN].hasPathName("HLT_Dimuon0_Jpsi3p5_Muon2_v5", true, false) ) {
      fHLT_Dimuon0_Jpsi3p5_Muon2[fHLTN][1] = true;
      //Jpsi Filters
      for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltL1sL1DoubleMu0") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][0]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltPreDimuon0Jpsi3p5Muon2") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][1]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuonL1Filtered0") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][2]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuonL2PreFiltered0") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][3]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltTripleMuL3PreFiltered222") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][4]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltJpsiMuonL3Filtered3p5") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][5]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltDisplacedmumuVtxProducerJpsiMuon3p5") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][6]=true;
	}
	if (HLTObjects[fHLTN].filterLabels()[h] == "hltVertexmumuFilterJpsiMuon3p5") {
	  fHLT_Dimuon0_Jpsi3p5_Muon2_Filters[fHLTN][7]=true;
	}
      }
    }

    //for other version of the trigger
    if( HLTObjects[fHLTN].hasPathName("HLT_Dimuon0_Jpsi3p5_Muon2_v6", true, false) ) {
      fHLT_Dimuon0_Jpsi3p5_Muon2[fHLTN][1] = true;
      //Jpsi Filters                                                                                                                                         
      for (unsigned h = 0; h < HLTObjects[fHLTN].filterLabels().size(); ++h) {
        if (HLTObjects[fHLTN].filterLabels()[h] == "hltL1sL1DoubleMu0") {
    ...
    //Z Trigger 
    //if( HLTObjects[fHLTN].hasPathName("HLT_Trimuon5_3p5_2_Upsilon_Muon", false, false) ){
    //fHLT_Trimuon5_3p5_2_Upsilon_Muon[fHLTN][0] = true;
    //will do latter
    ...
    if( HLTObjects[fHLTN].hasPathName("HLT_Dimuon0_Jpsi3p5_Muon2_v5", true, false) ) fHLT_Dimuon0_Jpsi3p5_Muon2[fHLTN][1] = true;
    ...
    if( HLTObjects[fHLTN].hasPathName("HLT_QuadMuon0_Dimuon0_Upsilon_v1", true, false) ) fHLT_QuadMuon0_Dimuon0_Upsilon[fHLTN][0] = true;
  ...
  /*
  std::cout<<"Passing L3: "<<pass1<<" Passing dimuon: "<<pass2<<std::endl;
  for (int hi=0;hi<5;hi++){
    std::cout<<"Passing the L3 muons trigger"<<std::endl;
    std::cout<<" The triggered pt"<< fHLT_Muon_L3Matching_Pt[hi] <<std::endl;
    std::cout<<" The triggered Eta"<< fHLT_Muon_L3Matching_Eta[hi] <<std::endl;
    std::cout<<" The triggered Phi"<< fHLT_Muon_L3Matching_Phi[hi] <<std::endl;
  }
  for (int hi=0;hi<5;hi++){
    std::cout<<"Passing the Vertexing muons trigger"<<std::endl;
    std::cout<<" The triggered pt"<< fHLT_Muon_VtxMatching_Pt[hi] <<std::endl;
    std::cout<<" The triggered Eta"<< fHLT_Muon_VtxMatching_Eta[hi] <<std::endl;
    std::cout<<" The triggered Phi"<< fHLT_Muon_VtxMatching_Phi[hi] <<std::endl;
...
void PATEventTree::fillJPsiMuMuCand(const reco::CompositeCandidateCollection& JPsiCands, const reco::MuonRefVector& goodMuons, std::vector<TransientTrack>& t_tks) {
  ...
  for(unsigned int ijp = 0; ijp < JPsiCands.size(); ijp++) {
    ...
    // <sms cut>
    //if( JPsiCands[ijp].mass() < 2.75 || JPsiCands[ijp].mass() > 3.45  ) continue;//himal remove of requirement just for check.Should add for 2017.
    fJPsiIndex[fJPsiN] = fJPsiN;

    fJPsiCharge[fJPsiN] = (float) JPsiCands[ijp].charge();
    fJPsiPhi[fJPsiN] = (float) JPsiCands[ijp].phi();
    fJPsiTheta[fJPsiN] = (float) JPsiCands[ijp].theta();
    fJPsiEta[fJPsiN] = (float) JPsiCands[ijp].eta();
    fJPsiRapidity[fJPsiN] = (float) JPsiCands[ijp].rapidity();
    fJPsiP[fJPsiN] = (float) JPsiCands[ijp].p();
    fJPsiPt[fJPsiN] = (float) JPsiCands[ijp].pt();
    fJPsiPx[fJPsiN] = (float) JPsiCands[ijp].px();
    fJPsiPy[fJPsiN] = (float) JPsiCands[ijp].py();
    fJPsiPz[fJPsiN] = (float) JPsiCands[ijp].pz();
    fJPsiEnergy[fJPsiN] = (float) JPsiCands[ijp].energy();
    fJPsiEt[fJPsiN] = (float) JPsiCands[ijp].et();
    fJPsiMass[fJPsiN] = (float) JPsiCands[ijp].mass();
    fJPsiMt[fJPsiN] = (float) JPsiCands[ijp].mt();

    for(unsigned int ijpd = 0; ijpd < JPsiCands[ijp].numberOfDaughters(); ijpd++) {
      if( ijpd==2 ) { cout<<"more than 2 JPsi daughters!"<<endl; break; }
      
      const Candidate* daughter = JPsiCands[ijp].daughter( ijpd );
    ...
    //if( fJPsiMuCategory[fJPsiN][0]>0 && fJPsiMuCategory[fJPsiN][1]>0 && fJPsiMass[0]>2.80 && fJPsiMass[0]<3.40 ) {//should change for Upsilon
    if( fJPsiMuCategory[fJPsiN][0]>0 && fJPsiMuCategory[fJPsiN][1]>0 && fJPsiMass[0]>2.8 && fJPsiMass[0]<110.0 ) {//should change for Upsilon
    ...
    //    cout << "<sms 3> fillJPsiMuMuCand : fJPsiN =" << fJPsiN << endl;
...
void PATEventTree::makeEtabCand(std::vector<TransientTrack>& t_tks) {
  ...
  for(int ijp1 = 0; ijp1 < fJPsiMuMuN-1; ijp1++) {
    ...
    for(int ijp2 = ijp1+1; ijp2 < fJPsiMuMuN; ijp2++) {
      ...
      //----------Himal addition of cut------------------
      if (((fJPsiMass[ijp1] < 2.80 || fJPsiMass[ijp1] > 4.0)&&(fJPsiMass[ijp1] < 70 || fJPsiMass[ijp1] > 110)&&(fJPsiMass[ijp1] < 8.0 || fJPsiMass[ijp1] > 12.0)) || ((fJPsiMass[ijp2] < 2.80 || fJPsiMass[ijp2] > 4.0)&&(fJPsiMass[ijp2] < 70 || fJPsiMass[ijp2] > 110) && (fJPsiMass[ijp2] < 8.0 || fJPsiMass[ijp2] > 12.0))) continue; //Himal change for Z J Y  mass cut                                                                                                                                                      
      
      if (TMath::Prob(fJPsiChi2[ijp1],fJPsiNdof[ijp1])<0.005) continue;
      if (TMath::Prob(fJPsiChi2[ijp2],fJPsiNdof[ijp2])<0.005) continue;
       //------------muon pt cut...................
      if (fPcPt[fJPsiMuI[ijp1][0]]<3.) continue;
      if (fPcPt[fJPsiMuI[ijp1][1]]<3.) continue;
      if (fPcPt[fJPsiMuI[ijp2][0]]<3.) continue;
      if (fPcPt[fJPsiMuI[ijp2][1]]<3.) continue;
      ...
      if (fEtabProb[fEtabN]<0.005) continue;//Himal etab vtx cut
	...
	if( refit_tks.size()>1 ) {
      ...
      if (fEtabChi2[fEtabN]!=-9999) fEtabGoodProb++;
      fEtabN++;
